    ...
    <AppLayout>
      <div className="p-6 lg:p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          <Card className="bg-gradient-to-br from-primary/90 to-primary hover:from-primary hover:to-primary/90 text-primary-foreground transition-all cursor-pointer" onClick={() => router.push('/meetings/new')}>
          ...
          <Card className="hover:bg-secondary/50 transition-colors cursor-pointer" onClick={() => router.push('/admin/users')}>
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
          ...
          <Card className="hover:bg-secondary/50 transition-colors cursor-pointer" onClick={() => router.push('/transcripts')}>
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                <div className="p-3 bg-secondary rounded-xl">
          ...
          <Card className="hover:bg-secondary/50 transition-colors cursor-pointer" onClick={() => router.push('/analytics')}>
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                <div className="p-3 bg-secondary rounded-xl">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {stats?.enrolledSpeakers || 0} enrolled speakers
              </p>
            </CardContent>
          </Card>
              ...
              <p className="text-xs text-muted-foreground">
                {!!stats?.overdueActionItems && (
                  <span className="text-destructive font-medium">
                    {stats.overdueActionItems} overdue
                  </span>
                )}
                {!stats?.overdueActionItems && 'All on track'}
              </p>
            </CardContent>
          </Card>
        </div>
            ...
            <CardContent>
              {recentMeetings.length === 0 ? (
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>No meetings yet</p>
                  <Button variant="link" onClick={() => router.push('/meetings/new')} className="mt-2">
