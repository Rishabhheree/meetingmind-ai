                      ...
                      <TableCell>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem onClick={(e) => { e.stopPropagation(); navigate(`/meetings/${meeting.id}`); }}>
                              <Eye className="h-4 w-4 mr-2" />View Details
                            </DropdownMenuItem>
                            {meeting.status === 'scheduled' && (
                              <DropdownMenuItem onClick={(e) => { e.stopPropagation(); navigate(`/meetings/${meeting.id}/room`); }}>
                                <Play className="h-4 w-4 mr-2" />Start Meeting
                              </DropdownMenuItem>
                            )}
                            <DropdownMenuItem className="text-destructive" onClick={(e) => { e.stopPropagation(); handleDelete(meeting.id); }}>
