      ...
      <div className="p-6 lg:p-8 space-y-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            <Button variant="ghost" size="sm" onClick={() => router.push('/meetings')} className="mb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <Badge
                variant={meeting.status === 'active' ? 'default' : meeting.status === 'completed' ? 'secondary' : 'outline'}
              >
                {meeting.status}
              </Badge>
            </div>
          ...
          <div className="flex gap-2">
            {meeting.status === 'active' && (
              <Button onClick={() => router.push(`/meetings/${meeting.id}/room`)}>
                  ...
                  {segments.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {segments.map((segment) => (
                        <div
                          key={segment.id}
                          className="transcript-line p-3 rounded-lg bg-secondary/30 hover:bg-secondary/50 transition-colors"
                        >
