        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Insights and metrics across your meetings and transcriptions
            </p>
          </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {analytics.transcriptions.totalWords.toLocaleString()}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    {Math.round(analytics.transcriptions.avgWordsPerMeeting)} avg/meeting
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {formatPercentage(analytics.speakers.recognitionRate)}
                  </div>
                  <SimpleProgress
                    value={analytics.speakers.recognitionRate * 100}
                    className="mt-2 h-1"
                  />
                </CardContent>
              </Card>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Voice enrollment and identification metrics
                  </CardDescription>
                </CardHeader>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-secondary/30 rounded-lg">
                      <div className="text-3xl font-bold">
                        {formatPercentage(analytics.speakers.avgConfidence)}
                      </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Extracted tasks completion status
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-4 border-t">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {formatPercentage(analytics.actionItems.completionRate)}
                      </span>
                    </div>
                    <SimpleProgress
                      value={analytics.actionItems.completionRate * 100}
                      className="mt-2 h-2"
                    />
                  </div>
                </CardContent>
            ...
            {/* Meeting Timeline Chart (simplified) */}
            <Card>
              <CardHeader>
                <CardTitle>Meeting Activity</CardTitle>
                <CardDescription>
                  Number of meetings per day over the period
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {analytics.meetings.byDay.length > 0 ? (
                    analytics.meetings.byDay.slice(-30).map((day, i) => {
                      const maxCount = Math.max(
                        ...analytics.meetings.byDay.map((d) => d.count)
                      );
